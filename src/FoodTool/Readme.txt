...
Important 'need to know':
	...
	----> The root of the problem is excess calories and pharmaceutical industry
		  shamelessly spreading misleading information to sell all sorts of medicine and services:
		    - diabetes medicine
				- diabetes is obviously caused by excess calories
		    - ineffective cancer treatment
				- average cancer is probably caused by the delusional avoidance of trans fats
		    - dementia medicine
				- dementia is associated by excess calories, not fat, but fat is blamed by many
				  (https://www.researchgate.net/publication/229322101_Relative_Intake_of_Macronutrients_Impacts_Risk_of_Mild_Cognitive_Impairment_or_Dementia)
